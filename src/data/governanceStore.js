...
function seedItem(opts) {
  ...
  const item = {
    ...
    // 国内托管地址来自治理负责人回传的治理结果，不自动生成；未回传则为空，备份时校验不通过
    ...
    // 恶意代码检出数（治理模板「恶意代码」列解析所得）
    malwareCount: opts.malwareCount ?? 0,
...
/**
 * 恶意代码数：治理模板「恶意代码」为 JSON 数组文本（每条一项检出记录），
 * 数组条数即恶意代码检出数，用于治理页「恶意代码数」列展示。
 */
export function countMalwareItems(malwareText) {
  let list = []
  try {
    list = JSON.parse(malwareText || '[]')
  } catch (err) {
    return 0
  }
...
export function seedGovernanceData() {
  ...
  softwareList.value.push(
    ...
    // Vue.js 源码原本就托管在 AtomGit，故源码地址与国内托管地址为同一个 AtomGit 地址
    ...
    // 备份失败：回传的国内托管地址为空，校验未通过
    seedItem({ name: 'Hutool', version: '5.8.27', lang: 'Java', license: 'MPL-2.0', file: 'hutool-5.8.27.jar', developer: 'dromara', govOwner: '陈晓峰', govOrg: '阿里巴巴集团', currentStep: 1, createdAt: '2026-08-09 17:20', submitter: '陈晓峰', submitOrg: '阿里巴巴集团', backupStatus: '备份失败', repoUrl: 'https://github.com/dromara/hutool.git', logs: [{ time: '2026-08-09 17:45', level: 'warn', msg: '备份失败：未回传国内托管地址，请先在治理结果中补充后重新回传' }] }),
    // —— 步骤2：软件评分（备份完成 → 自动扫描 + 国标评分） ——
    seedItem({ name: 'Spring Framework', version: '6.1.5', lang: 'Java', license: 'Apache-2.0', file: 'spring-framework-6.1.5.jar', developer: 'VMware', govOwner: '李思远', govOrg: '华为技术有限公司', currentStep: 2, createdAt: '2026-08-09 14:30', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/spring-framework', lastSync: '2026-08-15 12:10', scaProgress: 100, copyrightProgress: 60, malwareProgress: 0 }),
    seedItem({ name: 'Log4j', version: '2.23.1', lang: 'Java', license: 'Apache-2.0', file: 'log4j-2.23.1.jar', developer: 'Apache', govOwner: '王明远', govOrg: '平安科技', currentStep: 2, createdAt: '2026-08-10 10:05', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/log4j', lastSync: '2026-08-15 11:00', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 3, malwareCount: 2 }),
    // 待扫描：备份已完成，尚未发起扫描（三项检测进度均为 0）
    seedItem({ name: 'MySQL', version: '8.4.0', lang: 'C/C++', license: 'GPL-2.0', file: 'mysql-8.4.0.tar.gz', developer: 'Oracle', govOwner: '张建国', govOrg: '中国工商银行', currentStep: 2, createdAt: '2026-08-14 09:10', backupStatus: '备份成功', repoUrl: 'https://github.com/mysql/mysql-server.git', mirrorUrl: 'https://atomgit.com/opensource/mysql', lastSync: '2026-08-14 10:05', scaProgress: 0, copyrightProgress: 0, malwareProgress: 0 }),
    // 待扫描：源码在 AtomGit，备份完成待扫描
    seedItem({ name: 'Ant Design', version: '5.18.3', lang: 'TypeScript', license: 'MIT', file: 'ant-design-5.18.3.zip', developer: '阿里巴巴集团', govOwner: '陈晓峰', govOrg: '阿里巴巴集团', currentStep: 2, createdAt: '2026-08-14 11:25', backupStatus: '备份成功', repoUrl: 'https://atomgit.com/opensource/ant-design', mirrorUrl: 'https://atomgit.com/opensource/ant-design', lastSync: '2026-08-14 12:00', scaProgress: 0, copyrightProgress: 0, malwareProgress: 0 }),
    // 扫描中：SCA 已完成，版权检测进行中，恶意代码检测未开始
    seedItem({ name: 'Elasticsearch', version: '7.17.22', lang: 'Java', license: 'Elastic-2.0', file: 'elasticsearch-7.17.22.tar.gz', developer: 'Elastic', govOwner: '李思远', govOrg: '华为技术有限公司', currentStep: 2, createdAt: '2026-08-13 15:40', backupStatus: '备份成功', repoUrl: 'https://github.com/elastic/elasticsearch.git', mirrorUrl: 'https://atomgit.com/opensource/elasticsearch-7', lastSync: '2026-08-13 16:20', scaProgress: 100, copyrightProgress: 45, malwareProgress: 0, assessStatus: '评估中' }),
    // 扫描中：三项检测并行推进中
    seedItem({ name: 'Grafana', version: '11.1.0', lang: 'TypeScript', license: 'AGPL-3.0', file: 'grafana-11.1.0.tar.gz', developer: 'Grafana Labs', govOwner: '王明远', govOrg: '平安科技', currentStep: 2, createdAt: '2026-08-13 10:30', backupStatus: '备份成功', repoUrl: 'https://github.com/grafana/grafana.git', mirrorUrl: 'https://atomgit.com/opensource/grafana', lastSync: '2026-08-13 11:15', scaProgress: 72, copyrightProgress: 38, malwareProgress: 15, assessStatus: '评估中' }),
    // 评估完成：三项检测均成功，国标评分已出（无漏洞）
    seedItem({ name: 'Protobuf', version: '25.3', lang: 'C/C++', license: 'BSD-3-Clause', file: 'protobuf-25.3.tar.gz', developer: 'Google', govOwner: '张建国', govOrg: '中国工商银行', currentStep: 2, createdAt: '2026-08-11 14:20', backupStatus: '备份成功', repoUrl: 'https://github.com/protocolbuffers/protobuf.git', mirrorUrl: 'https://atomgit.com/opensource/protobuf', lastSync: '2026-08-11 15:10', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 0 }),
    // 评估完成：三项检测均成功，检出多个漏洞，国标评分已出
    seedItem({ name: 'Struts2', version: '2.5.33', lang: 'Java', license: 'Apache-2.0', file: 'struts2-2.5.33.jar', developer: 'Apache', govOwner: '陈晓峰', govOrg: '阿里巴巴集团', currentStep: 2, createdAt: '2026-08-10 16:45', backupStatus: '备份成功', repoUrl: 'https://github.com/apache/struts.git', mirrorUrl: 'https://atomgit.com/opensource/struts', lastSync: '2026-08-10 17:30', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 7, malwareCount: 1 }),
    // 评估完成：三项检测均成功，检出少量漏洞
    seedItem({ name: 'Tomcat', version: '10.1.25', lang: 'Java', license: 'Apache-2.0', file: 'tomcat-10.1.25.tar.gz', developer: 'Apache', govOwner: '李思远', govOrg: '华为技术有限公司', currentStep: 2, createdAt: '2026-08-09 09:50', backupStatus: '备份成功', repoUrl: 'https://github.com/apache/tomcat.git', mirrorUrl: 'https://atomgit.com/opensource/tomcat', lastSync: '2026-08-09 10:40', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 2 }),
    // —— 步骤3：治理成果评估（评分完成，待人工评估意见） ——
    seedItem({ name: 'OpenSSL', version: '3.3.0', lang: 'C', license: 'Apache-2.0', file: 'openssl-3.3.0.tar.gz', developer: 'OpenSSL Software Foundation', govOwner: '张建国', govOrg: '中国工商银行', currentStep: 3, createdAt: '2026-08-06 11:20', repoUrl: 'https://github.com/openssl/openssl.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/openssl', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 4 }),
    // 待评审：评分完成，尚未给出评估意见
    seedItem({ name: 'RabbitMQ', version: '3.13.6', lang: 'Erlang', license: 'MPL-2.0', file: 'rabbitmq-3.13.6.tar.gz', developer: 'Broadcom', govOwner: '李思远', govOrg: '华为技术有限公司', currentStep: 3, createdAt: '2026-08-08 10:30', repoUrl: 'https://github.com/rabbitmq/rabbitmq-server.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/opensource/rabbitmq', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 1 }),
    // 待评审：无漏洞，评分较高，等待评估
    seedItem({ name: 'Fastjson2', version: '2.0.52', lang: 'Java', license: 'Apache-2.0', file: 'fastjson2-2.0.52.jar', developer: '阿里巴巴集团', govOwner: '陈晓峰', govOrg: '阿里巴巴集团', currentStep: 3, createdAt: '2026-08-07 14:15', repoUrl: 'https://github.com/alibaba/fastjson2.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/opensource/fastjson2', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 0 }),
    // 评审通过：治理结果合规，已给出评估意见并记录历史
    seedItem({ name: 'PostgreSQL', version: '16.4', lang: 'C', license: 'PostgreSQL', file: 'postgresql-16.4.tar.gz', developer: 'PostgreSQL Global Development Group', govOwner: '张建国', govOrg: '中国工商银行', currentStep: 3, createdAt: '2026-08-05 09:40', repoUrl: 'https://github.com/postgres/postgres.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/opensource/postgresql', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 0, reviewStatus: '评审通过', reviewComment: '许可证合规、无高危漏洞，治理结果符合入库要求', reviewHistory: [{ result: '评审通过', opinion: '许可证合规、无高危漏洞，治理结果符合入库要求', operator: '当前用户', timestamp: '2026-08-05 11:20' }] }),
    // 评审通过：存在中低危漏洞但已有修复计划，准予通过
    seedItem({ name: 'Dubbo', version: '3.3.0', lang: 'Java', license: 'Apache-2.0', file: 'dubbo-3.3.0.jar', developer: 'Apache', govOwner: '李思远', govOrg: '华为技术有限公司', currentStep: 3, createdAt: '2026-08-04 16:05', repoUrl: 'https://github.com/apache/dubbo.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/opensource/dubbo', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 2, reviewStatus: '评审通过', reviewComment: '存在 2 个中危漏洞，治理方已提供修复计划，同意通过', reviewHistory: [{ result: '评审不通过', opinion: '中危漏洞未提供修复计划，请补充后重新评估', operator: '当前用户', timestamp: '2026-08-04 17:30' }, { result: '评审通过', opinion: '存在 2 个中危漏洞，治理方已提供修复计划，同意通过', operator: '当前用户', timestamp: '2026-08-05 09:10' }] }),
    // 评审不通过：检出高危漏洞且未修复，退回重新治理
    seedItem({ name: 'Shiro', version: '2.0.2', lang: 'Java', license: 'Apache-2.0', file: 'shiro-2.0.2.jar', developer: 'Apache', govOwner: '王明远', govOrg: '平安科技', currentStep: 3, createdAt: '2026-08-03 11:50', repoUrl: 'https://github.com/apache/shiro.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/opensource/shiro', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 6, reviewStatus: '评审不通过', reviewComment: '检出 2 个高危漏洞且未提供修复方案，退回治理方重新处理', reviewHistory: [{ result: '评审不通过', opinion: '检出 2 个高危漏洞且未提供修复方案，退回治理方重新处理', operator: '当前用户', timestamp: '2026-08-03 15:20' }], logs: [{ time: '2026-08-03 15:20', level: 'warn', msg: '评审结果：评审不通过，意见：检出 2 个高危漏洞且未提供修复方案，退回治理方重新处理' }] }),
    // 评审不通过：许可证存在兼容性风险，需重新确认
    seedItem({ name: 'MinIO', version: 'RELEASE.2024-06-13', lang: 'Go', license: 'AGPL-3.0', file: 'minio-2024-06-13.tar.gz', developer: 'MinIO, Inc.', govOwner: '陈晓峰', govOrg: '阿里巴巴集团', currentStep: 3, createdAt: '2026-08-02 09:25', repoUrl: 'https://github.com/minio/minio.git', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/opensource/minio', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, vulnCount: 1, reviewStatus: '评审不通过', reviewComment: 'AGPL-3.0 许可证与商用场景存在兼容性风险，需法务确认后重新评估', reviewHistory: [{ result: '评审不通过', opinion: 'AGPL-3.0 许可证与商用场景存在兼容性风险，需法务确认后重新评估', operator: '当前用户', timestamp: '2026-08-02 14:10' }], logs: [{ time: '2026-08-02 14:10', level: 'warn', msg: '评审结果：评审不通过，意见：AGPL-3.0 许可证与商用场景存在兼容性风险，需法务确认后重新评估' }] }),
    ...
    seedItem({ name: 'Vue Router', version: '4.4.0', lang: 'TypeScript', license: 'MIT', file: 'vue-router-4.4.0.zip', developer: '尤雨溪', govOwner: '张建国', govOrg: '中国工商银行', currentStep: 4, createdAt: '2026-08-01 10:20', repoUrl: 'https://atomgit.com/opensource/vue-router', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/vue-router', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, reviewStatus: '评审通过', reviewComment: '无高危漏洞，许可证合规，准予提交入库', warehouseStatus: '待审批', vulnCount: 0 }),
    ...
    // 已入库：平台管理员审批通过
    seedItem({ name: 'Zookeeper', version: '3.9.2', lang: 'Java', license: 'Apache-2.0', file: 'zookeeper-3.9.2.tar.gz', developer: 'Apache', govOwner: '王明远', govOrg: '平安科技', currentStep: 4, createdAt: '2026-07-18 09:45', repoUrl: 'https://atomgit.com/opensource/zookeeper', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/zookeeper', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, reviewStatus: '评审通过', reviewComment: '治理结果合规，准予入库', warehouseStatus: '已入库', vulnCount: 0, warehouseTime: '2026-07-24 11:10' }),
    // 已入库：许可证合规，平台管理员审批通过
    seedItem({ name: 'MyBatis', version: '3.5.16', lang: 'Java', license: 'Apache-2.0', file: 'mybatis-3.5.16.jar', developer: 'MyBatis', govOwner: '陈晓峰', govOrg: '阿里巴巴集团', currentStep: 4, createdAt: '2026-07-15 15:30', repoUrl: 'https://atomgit.com/opensource/mybatis', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/mybatis', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, reviewStatus: '评审通过', reviewComment: '许可证合规、无高危漏洞，准予入库', warehouseStatus: '已入库', vulnCount: 1, warehouseTime: '2026-07-21 09:50' }),
    // 已拒绝：检出高危漏洞，平台管理员拒绝
    seedItem({ name: 'Log4j 1.x', version: '1.2.17', lang: 'Java', license: 'Apache-2.0', file: 'log4j-1.2.17.jar', developer: 'Apache', govOwner: '李思远', govOrg: '华为技术有限公司', currentStep: 4, createdAt: '2026-07-12 11:15', repoUrl: 'https://atomgit.com/opensource/log4j-1', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/log4j-1', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, reviewStatus: '评审通过', warehouseStatus: '已拒绝', vulnCount: 9, rejectReason: '该版本已停止维护且存在多个未修复超危漏洞，禁止入库，建议升级至 2.x', logs: [{ time: '2026-07-14 10:20', level: 'warn', msg: '已拒绝，拒绝原因：该版本已停止维护且存在多个未修复超危漏洞，禁止入库，建议升级至 2.x' }] }),
    // 已拒绝：许可证与商用场景不兼容，平台管理员拒绝
    seedItem({ name: 'CockroachDB', version: '24.1.2', lang: 'Go', license: 'BUSL-1.1', file: 'cockroachdb-24.1.2.tgz', developer: 'Cockroach Labs', govOwner: '张建国', govOrg: '中国工商银行', currentStep: 4, createdAt: '2026-07-10 16:40', repoUrl: 'https://atomgit.com/opensource/cockroachdb', backupStatus: '备份成功', mirrorUrl: 'https://atomgit.com/mirror/cockroachdb', scaProgress: 100, copyrightProgress: 100, malwareProgress: 100, assessStatus: '评估完成', scored: true, reviewStatus: '评审通过', warehouseStatus: '已拒绝', vulnCount: 0, rejectReason: 'BUSL-1.1 许可证限制商用，与业务场景不兼容，不予入库', logs: [{ time: '2026-07-13 14:05', level: 'warn', msg: '已拒绝，拒绝原因：BUSL-1.1 许可证限制商用，与业务场景不兼容，不予入库' }] }),
  )
...
export function importFromInbound(entries, inbound) {
  ...
  const created = entries.map((e) => {
    ...
    const item = {
      ...
      desc: e.desc || '—',
      deps: e.deps || '—',
      malwareCount: countMalwareItems(e.malware),
      vulns: e.vulns || '—',
      malware: e.malware || '—',
      devInfo: e.devInfo || '—',
